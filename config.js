...
module.exports = {
    ...
    STICKER_DATA: process.env.STICKER_DATA || "Nozen",
    BOT_NAME: process.env.BOT_NAME || 'Nozen',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Nozen MD bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
